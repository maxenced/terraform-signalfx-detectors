...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.probes_errors_notifications, "critical", []), var.notifications.critical)
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.probes_errors_notifications, "major", []), var.notifications.major)
    runbook_url           = try(coalesce(var.probes_errors_runbook_url, var.runbook_url), "")
    tip                   = var.probes_errors_tip
    parameterized_subject = var.message_subject == "" ? local.rule_subject : var.message_subject
    parameterized_body    = var.message_body == "" ? local.rule_body : var.message_body
...
EOF
  ...
  rule {
    ...
    notifications         = coalescelist(lookup(var.cache_hit_rate_notifications, "warning", []), var.notifications.warning)
